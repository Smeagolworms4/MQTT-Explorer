...
module.exports = {
  ...
  resolve: {
    alias: {
      'fs': path.resolve(__dirname, '../node-server/browser-wrapper/fs'),
      'electron': path.resolve(__dirname, '../node-server/browser-wrapper/electron'),
      'electron-updater': path.resolve(__dirname, '../node-server/browser-wrapper/electron-updater'),
    },
